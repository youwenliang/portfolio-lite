...
class TopicB extends Component {
  ...
  render() {
    return (
      <div id="send">
        <header className="project-header bg-blue-1 h5 pt6">
        </header>
        ...
        <section className="center mw8 ph4 min-vh-100 mt5-ns mt4">
          <hr className="dash bg-blue-1" /><span className="f12 ttu ml3 fw7">Firefox Send</span>
          <div id="intro" className="mw7 ph5-l ph0">
            ...
            <div className="mt4 pt3">
              <a href="#" target="_blank" className="br1 near-black button no-underline f12 fw7 mr3 pa3 bg-blue-1 hover-bg-blue-1 white">Launch Prototype</a>
