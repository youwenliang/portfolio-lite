...
class TopicA extends Component {
    ...
    .then(function (allImgs) {
      setTimeout(function(){        
        ...
        setTimeout(function(){
          ...
          $('#screenshots .hidediv').each(function(i){
  ...
  render() {
    return (
      <div id="screenshots">
        <header className="project-header bg-green-1 h5 pt6">
        </header>
        ...
        <section className="center mw8 ph4 min-vh-100 mt5-ns mt4">
          <hr className="dash bg-green-1" /><span className="f12 ttu ml3 fw7">Firefox Screenshots</span>
          <div id="intro" className="mw7 ph5-l ph0">
            ...
            <div className="mt4 pt3">
              <a href="#" target="_blank" className="br1 near-black button no-underline f12 fw7 mr3 pa3 bg-green-1 hover-bg-green-1 white">Launch Prototype</a>
        ...
        <section className="mv2 pv4 hideme hidediv">
          <div className="center mw8 space-between ph4">
            <Link to='/firefoxos-tv' className="near-black no-underline hover-move">
              <p className="ttu tracked f12 fw7 tl">Previous</p>
              <h4 className="tl fw2 f4">FirefoxOS TV</h4>
              <h4 className="tl">
                  <FontAwesome name='long-arrow-left' className="gold" />
              </h4>
            </Link>
            <Link to='/firefox-send' className="near-black no-underline hover-move">
              <p className="ttu tracked f12 fw7 tr">Next</p>
              <h4 className="tr fw2 f4">Firefox Send</h4>
              <h4 className="tr">
